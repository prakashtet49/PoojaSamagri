...
const AddtoCartItem = ({ item, count, onAddToCart, onIncrease, onDecrease }) => {
    ...
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: Color.primary_grey, padding: 10, borderRadius: 8, marginBottom: 10 }}>
            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <Text style={{ fontSize: 16, fontFamily: 'Roboto-Medium', color: 'black' }}>{item.item_name}</Text>
                        <Text style={{ fontSize: 14, color: 'black', fontFamily: 'Roboto-Light' }}>{item.quantity}</Text>
